            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-blue-500 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div className="bg-blue-100 rounded-lg p-3">
                  <svg width="24" height="24" fill="currentColor" className="text-blue-600" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/></svg>
                </div>
              </div>
              <div className="text-gray-600 text-sm font-medium mb-2">Users</div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-green-500 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div className="bg-green-100 rounded-lg p-3">
                  <svg width="24" height="24" fill="currentColor" className="text-green-600" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="2"/></svg>
                </div>
              </div>
              <div className="text-gray-600 text-sm font-medium mb-2">Sales</div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-purple-500 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div className="bg-purple-100 rounded-lg p-3">
                  <svg width="24" height="24" fill="currentColor" className="text-purple-600" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div className="bg-orange-100 rounded-lg p-3">
                  <svg width="24" height="24" fill="currentColor" className="text-orange-600" viewBox="0 0 24 24"><circle cx="12" cy="12" r="2"/><path d="M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"/></svg>
                </div>
              </div>
